...
export default function Home() {
  ...
  const FAQS = [
    ...
    },
    {
      ...
      a: '基本プランの料金内ですべて完結し、松山市内および周辺対応エリアの標準出張費も含んでおります。敷地内に複数のお墓（2基以上）がある場合や、広い区画（1坪超）の場合は、お申し込み画面のオプション選択にて明瞭な追加料金が事前に確認・確定しますので、事前の承諾なく追加費用を請求することは一切ございません。',
    },
    {
      q: '同じ区画内に複数のお墓や五輪塔、墓誌がある場合は対応できますか？',
      a: 'はい、もちろん対応可能です。1区画内に先祖代々墓のほか個人墓や五輪塔等がある場合、お申し込み時に「お墓の基数」をお選びいただくことで、基数に応じた追加料金（1基追加ごとに+3,000円）で丁寧にお手入れ・清掃いたします。',
    },
    {
      q: '寺院墓地や地域共同墓地、みなし墓地でも対応してもらえますか？',
      a: 'はい、公営霊園・民営霊園・寺院墓地・山間部の地域共同墓地など、どのような形態のお墓でも対応可能です。同姓の多い地域墓地でも間違えないよう、正面文字と側面の「建立者名」を基に現場で確実に特定いたします。',
    },
    {
      q: 'お供えするお花（シキミ）やお線香の変更・宗派の希望は可能ですか？',
      a: '全プランで新鮮なシキミ（樒）一対とお線香をお供えして合掌礼拝いたします。神道（榊のお供え）やキリスト教、生花への変更等のご要望にも柔軟に対応いたします。お申し込み時の備考欄にご記入ください。',
    },
    {

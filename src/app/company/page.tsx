        ...
        <div className="bg-gradient-to-br from-stone-900 via-stone-850 to-stone-900 text-white rounded-3xl p-8 sm:p-10 shadow-lg space-y-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs sm:text-sm text-emerald-400 font-bold">
              〜元・理学療法士養成校教員が、なぜ「お墓参り代行DX」を作ったのか〜
            </p>
          </div>
          ...
          <div className="text-stone-300 text-xs sm:text-sm leading-relaxed space-y-4">
            <p>
              ...
              私は20年以上にわたり、医療・福祉現場で理学療法士として、そして理学療法士を養成する専門学校の教員として、多くの学生や患者様と向き合ってきました。多忙を極める教育現場で「本当にやりたい教育や、学生一人ひとりと向き合う時間を取り戻したい」という一心から、現場の煩雑な業務を自動化する独自システム《INTEVE SCHOOL》（特許出願中・商標登録済）をゼロから開発し、校務DXを推進してまいりました。
            </p>
            <p className="font-bold text-white">
              そんな私が、なぜ一見まったく異なる分野に見える「お墓参り・お掃除代行」のプラットフォームを立ち上げたのか。<br />
              そこには、ごく私的な、しかしこれからの時代において誰にとっても他人事ではない実体験がありました。
            </p>
            <div className="bg-stone-800/80 border-l-4 border-emerald-500 p-4 sm:p-5 rounded-r-2xl space-y-2 my-2">
              <p className="text-white font-bold">
                2026年9月、私は父を亡くしました。
              </p>
              <p className="text-stone-300 text-xs sm:text-sm">
                深い悲しみと、葬儀・法要に追われるドタバタの中で、親族や関係者をはじめ本当に多くの方々と話をする機会がありました。そんな中、ふと自分の息子と言葉を交わした時のことです。<br />
                まだ若い息子にとって「死」や「供養」に現実味が湧かないのは当然のことですが、彼からポツリと、<br />
                <span className="text-amber-300 font-bold">『（愛媛のお墓は遠いから）僕、将来お父さんのお墓参りに来るの大変だなぁ……』</span><br />
                と、嘘偽りのない素直な本音を漏らされたのです。
              </p>
            </div>
            <p>
              ハッとさせられました。<br />
              核家族化や都市部への移住が進む現代において、親を敬い先祖に手を合わせたい気持ちはあっても、「距離」や「日々の忙しさ」がどうしても大きな壁になってしまう。墓参や供養の引き継ぎは、私個人の家庭だけでなく、日本全国で多くの人々が直面している切実な課題なのだと身をもって痛感しました。
            </p>
            <p>
              その後、父の墓地を管理されている会社の方と今後の手続きについてお話ししていた際、管理所側もまた「遠方施主様への連絡の難しさ」や「日々の電話相談・業者取次ぎ業務の膨大な負担」に悩まされている現状を伺い、まさに<strong>『これを解決できるオンラインの仕組みが作れないだろうか』</strong>という大きなヒントをいただいたのです。
            </p>
            <div className="bg-emerald-950/60 border border-emerald-500/40 p-4 rounded-2xl">
              <p className="text-emerald-200 font-bold">
                『せっかく作るなら、自分がこれまで教育・業務DXで培ってきたIT技術や特許ノウハウをすべて総動員して、どこよりも簡単で安心できる仕組みを本気で作ってみよう』
              </p>
            </div>
            <p>
              そう決意して開発したのが、このお墓参り・お掃除代行DXプラットフォーム<strong>「ココロモウ」</strong>です。
            </p>
            <p>
              施主様にとっては、遠方にいてもスマホひとつでお墓の状況を確認でき、安心してお参りをお願いできること。<br />
              霊園・寺院様にとっては、面倒な電話相談や業者取次ぎの手間から解放され、本来の霊園管理や法要に専念できること。<br />
              そして提携する地元の職人様にとっては、確かな仕事が正当に評価され、地域に根ざした持続可能な受注につながること。
            </p>
            <p>
              <strong>『創造的な“こと”に、そして本当に向き合いたい大切な人に、自分と時間を取り戻す』</strong>という私の想いは、教育現場でも、供養の現場でも、根底ではすべてひとつにつながっています。
            </p>
          </div>

...
--------------------------------------------------`,
    ...
    clients: [
      ...
      },
      {
        ...
        cemeteryCompanyId: 'cem_comp_001',
        name: '加藤 宗一郎',
        phoneNumber: '090-5555-7788',
        postalCode: '790-0854',
        address: '愛媛県松山市持田町2丁目4-15',
        email: 'kato.soichiro@example.com',
        sectionPlotNumber: '中央区 1列 08番',
        frontInscription: '加藤家代々之墓',
        builderName: '平成二十年三月 加藤宗一郎建之',
        initialPassword: 'client1234',
        photoUrl: '/images/grave_front_example.jpg',
        builderPhotoUrl: '/images/grave_side_builder_example.jpg',
        notes: '管理事務所から正面中央通路をまっすぐ進んで左手すぐ。水汲み場正面。',
        importedAt: '2026-03-01T08:00:00Z',
        lastOrderDate: '2026-03-20T10:00:00Z',
        orderCount: 1,
        subscriptionType: 'annual',
        annualFrequency: 3,
        annualCompletedCount: 1,
        nextScheduledDate: '2026-08-12',
        currentOrderId: 'order_annual_sample_001',
      },
    ],
  },
  {
...
export const SAMPLE_ORDERS: Order[] = [
  {
    id: 'order_annual_sample_001',
    orderNumber: 'KKM-20260315-ANN01',
    clientId: 'client_004',
    clientName: '加藤 宗一郎',
    clientEmail: 'kato.soichiro@example.com',
    clientPhone: '090-5555-7788',
    cemeteryCompanyId: 'cem_comp_001',
    ...
    annualDiscountAmount: 5328, // 通常 14,800 * 3 = 44,400 -> 実質 13,024 * 3 = 39,072
    totalAmount: 39072,
    platformFeeAmount: 7814,
    vendorPayoutAmount: 31258,
    currency: 'jpy',
    stripeCheckoutSessionId: 'cs_test_annual_session_789',
    stripePaymentIntentId: 'pi_test_annual_pi_789',
    status: 'paid',
    scheduledPeriods: ['春彼岸（3月）', 'お盆（8月）', '秋彼岸（9月）'],
    annualSchedules: [
      {
        index: 1,
        periodLabel: '春彼岸（3月）',
        ...
        vendorNotes: '春のお彼岸にあわせ、水洗い・除草および生花（シキミ）のお供えを完了いたしました。',
        clientNotes: 'お彼岸中日（3/20）までに清掃完了希望。',
      },
      {
        index: 2,
        periodLabel: 'お盆（8月）',
        ...
        status: 'scheduled',
        vendorNotes: '',
        clientNotes: '家族が8/13に墓参予定のため、8/12までに仕上げをお願いします。',
      },
      {
        index: 3,
        periodLabel: '秋彼岸（9月）',
    ...
    graveInfo: {
      ...
      deceasedName: '加藤家代々之墓',
      graveCount: 1,
      plotSize: 'standard',
      landmarksDescription: '管理事務所から正面中央通路をまっすぐ進んで左手すぐ。水汲み場正面。',
      specialRequests: '年間定期管理（年3回）。お盆と春秋彼岸にお参り代行をお願いします。',
    },
    preferredDate: '2026-03-20',
    createdAt: '2026-03-15T09:30:00Z',
    paidAt: '2026-03-15T09:35:00Z',
...
export const SAMPLE_REPORTS: Report[] = [
  {
    id: 'rep_sample_annual_001',
    orderId: 'order_annual_sample_001',
    vendorId: 'vendor_001',
    vendorName: '松山まごころ墓苑サポート（ダミー提携パートナー）',
    workDate: '2026-03-20',
    weather: '晴れ（松山・春彼岸）',
    beforePhotos: [
      {
        ...
        caption: '作業前：冬場の落ち葉および墓石の苔・砂埃の付着状況',
      },
    ],
    afterPhotos: [
      {
        url: '/images/grave_after.jpg',
        caption: '作業後（1回目・春彼岸完了）：手作業除草・墓石専用水洗い・新鮮なシキミとお線香の献花礼拝',
      },
    ],
    workNotes:
      '【年間定期管理 第1回目（春彼岸）完了報告】\n加藤家代々之墓にて、春彼岸のお参り代行・除草水洗い清掃を実施いたしました。区画内の雑草を丁寧に抜き取り、墓石・花立・水鉢を洗浄。新鮮なシキミを供え、お線香をあげて施主様に代わり真心込めて合掌礼拝いたしました。\n次回は8月のお盆（8/12予定）に第2回作業を実施いたします。',
    graveConditionNotes:
      '墓石本体・目地・花立て共に非常に健全な状態です。雑草の根も綺麗に除去いたしました。',
    status: 'submitted',

...
ehime_data = [
    [
        1, "中予", "松山市", "宝塔寺霊園・善福寺境内墓地・東榮寺・法寿院 総合窓口", "お墓のトータルエージェント（有限会社窓口）",
        "民間霊園・寺院墓地 総合管理エージェント", "愛媛県松山市土居田町455-16", "089-997-7466",
        "https://totalagent.net/", "https://totalagent.net/contact/",
        "大規模（複数霊園受託・数千区画）", "★【重要提携先】中予屈指のお墓総合受託エージェント。宝塔寺・善福寺等の受託・墓石・代行・墓じまいを網羅。"
    ],
    [
        2, "中予", "松山市", "宝塔寺 旭ヶ丘霊園", "宗教法人宝塔寺 / 旭ヶ丘霊園管理事務所",
        "寺院霊園管理事務所（自社モデル）", "愛媛県松山市祝谷東町甲582-1", "089-941-8920",
        "asahigaoka-cemetery@houtouji-reien.jp", "https://kokoromou.inteve-cloud.com/order",
        "大規模（約1,500区画）", "当システム公認第1号モデル霊園。松山市街一望の名門霊園。"
    ],
    [
        3, "中予", "松山市", "八坂霊園", "有限会社八坂開発（管理事務所）",
        "民間霊園管理会社", "愛媛県松山市浄瑠璃町773", "0120-16-2296 / 089-963-2345",
        "https://yasakareien.jp/", "https://yasakareien.jp/contact/",
        "超大規模（約2,000区画）", "四国霊場八坂寺隣接。専任スタッフ常駐・緑地整備された大規模民間霊園。"
    ],
    [
        4, "中予", "松山市", "松山中央霊園", "松山中央霊園管理事務所",
    ...
    [
        5, "中予", "松山市", "松山メモリアルヒルズ", "松山メモリアルヒルズ管理事務所",
        "民間公園霊園管理会社", "愛媛県松山市御幸1丁目", "089-923-2288",
        "https://memorialhills.jp/", "現地管理棟にて受付",
        "中〜大規模（約700区画）", "市街地至近（御幸山）のバリアフリー公園墓地。景観良好。"
    ],
    [
        6, "中予", "松山市", "道後聖墓苑", "道後聖墓苑管理事務所",
        "寺院・民間共同管理", "愛媛県松山市道後多幸町", "0120-60-2004",
        "http://dogoseiboen.com/", "http://dogoseiboen.com/inquiry",
        "中規模（約500区画）", "道後温泉至近の好立地霊園。専任管理事務所が窓口。"
    ],
    [
        7, "中予", "松山市", "せとうち霊園（北条地区）", "株式会社せとうち石材 / 霊園管理部",
        "民間公園霊園", "愛媛県松山市柳原", "089-994-3500",
        "http://setouchi-reien.jp/", "現地案内所",
        "中〜大規模（約600区画）", "旧北条市エリアの海を望む大型霊園。駐車場完備。"
    ],
    [
        8, "中予", "松山市", "北久米文殊苑（文殊院境内墓苑）", "宗教法人文殊院 / 霊園管理窓口",
        "寺院境内霊園（宗旨不問）", "愛媛県松山市北久米町", "089-975-1234",
        "現地文殊院寺務所", "現地窓口",
        "中規模（約400区画）", "伊予鉄北久米駅近郊の平坦地霊園。高齢のお参り客多数。"
    ],
    [
        9, "中予", "東温市", "松山メモリアルパーク", "松山メモリアルパーク管理事務所（株式会社市川屋）",
        "民間公園墓地管理事務所", "愛媛県東温市河之内871", "089-966-6332",
        "https://www.ichikawaya.info/", "現地管理事務所",
        "超大規模（約1,200区画）", "川内インター近くの広大な丘陵型公園霊園。"
    ],
    [
        10, "中予", "伊予市", "伊予聖地霊園", "有限会社伊予石材（管理事務所）",
        "民間霊園管理事務所", "愛媛県伊予市上三谷", "089-983-1483",
        "現地管理事務所", "電話・現地受付",
        "中規模（約450区画）", "伊予市街・松前町からのアクセス良好な高台霊園。"
    ],
    [
        11, "中予", "砥部町", "砥部総合霊園 / 砥部中央墓地", "砥部町石材事業協同組合 / 管理事務所",
        "組合・民間受託管理", "愛媛県伊予郡砥部町原町", "089-962-1483",
        "組合事務局窓口", "電話受付",
        "中規模（約500区画）", "砥部焼の里近くの緑豊かな丘陵霊苑。"
    ],
    [
        12, "中予", "松山市", "さくら石材株式会社（松山霊園開発部）", "さくら石材株式会社",
        "石材総合・霊園受託管理", "愛媛県松山市古三津2丁目12-8", "089-952-1483",
        "https://sakura-sekizai.com/", "https://sakura-sekizai.com/contact/",
        "広域受託（約1,000区画超）", "松山西部・三津浜中心に複数寺院墓地・霊園の施工管理を担当。"
    ],
    [
        13, "中予", "松山市", "山田石材株式会社（霊園開発管理）", "山田石材株式会社",
        "霊園開発・指定管理", "愛媛県松山市鷹子町528-1", "089-975-1414",
        "http://yamada-sekizai.co.jp/", "電話・店頭受付",
        "広域受託（数百区画）", "松山東部の中核石材店。寺院墓地管理の提携先として有力。"
    ],
    [
        14, "中予", "松山市", "オカザキ石材工業株式会社", "オカザキ石材工業株式会社",
        "霊園管理・石材施工", "愛媛県松山市朝生田町5丁目7-18", "089-933-1483",
        "https://okazaki-stone.jp/", "電話・店頭受付",
        "広域受託（数百区画）", "松山南部の老舗石材店。定期清掃・点検ニーズ共有パートナー。"
    ],
    [
        15, "中予", "松山市", "松山市営 横谷霊園・梅津寺墓地・大峰霊園 他", "松山市役所 都市整備部 公園緑地課",
        "公営霊園（自治体直営）", "愛媛県松山市二番町四丁目7-2", "089-948-6499",
        "kouen@city.matsuyama.ehime.jp", "https://www.city.matsuyama.ehime.jp/",
        "超大規模（市営全体約10,000区画）", "松山市最大の公営墓地群。使用者管理・承継・遠方施主の相談窓口。"
    ],
    [
        16, "東予", "今治市", "今治市営 大谷墓地・樋口墓地 他", "今治市石材加工協同組合（指定管理者）",
        "公営霊園・指定管理団体", "愛媛県今治市大内甲11-1", "0898-32-5264（組合）",
        "info@imabari-sekizai.or.jp", "http://www.imabari-sekizai.or.jp/",
        "大規模（約3,000区画）", "指定管理者として墓地維持管理を一括受託。提携価値極大。"
    ],
    [
        17, "東予", "今治市", "しまなみ中央霊苑 / 大島石霊園", "今治しまなみ石材管理部",
        "民間霊園・産地直営", "愛媛県今治市宮ケ崎", "0898-48-1483",
        "現地案内所", "電話受付",
        "中規模（約500区画）", "大島石の本場。島しょ部・本州からの移設・代行相談多数。"
    ],
    [
        18, "東予", "新居浜市", "新居浜メモリアルガーデン・各霊苑", "日東石材工業株式会社（管理部）",
        "民間霊園管理・石材大手", "愛媛県新居浜市坂井町1-5-18", "0897-41-4114 / 0120-14-1483",
        "info@nitto-sekizai.co.jp", "https://www.nitto-sekizai.co.jp/contact/",
        "超大規模（約2,500区画）", "東予エリア最大手の石材・霊園管理会社。施工・管理実績トップ。"
    ],
    [
        19, "東予", "西条市", "霊苑ごくらく / 西条聖地霊苑", "小野石材株式会社（管理部）",
    ...
    [
        20, "東予", "西条市", "西条市営 飯岡墓地・ひうち霊苑 他", "西条市役所 くらし支援課（環境衛生）",
        "公営霊園（自治体直営）", "愛媛県西条市明屋敷164番地", "0897-52-1338",
        "kurashishien@saijo-city.jp", "https://www.city.saijo.ehime.jp/",
        "大規模（約2,000区画）", "市営主要墓地を管轄する行政窓口。"
    ],
    [
        21, "東予", "四国中央市", "四国中央メモリアルヒルズ / 三島霊園", "有限会社宇摩石材（管理事務所）",
        "民間公園霊園", "愛媛県四国中央市三島中央", "0896-24-1483",
        "現地案内所", "電話受付",
        "中規模（約500区画）", "愛媛最東端（香川・徳島境）の拠点霊園。"
    ],
    [
        22, "南予", "大洲市", "大洲富士霊苑", "有限会社大洲石材（霊苑管理部）",
    ...
    [
        23, "南予", "八幡浜市", "八幡浜中央霊苑 / 穴井墓地", "株式会社八幡浜石材 / 管理窓口",
        "民間霊園管理", "愛媛県八幡浜市大平", "0894-22-1483",
        "現地管理所", "電話受付",
        "中規模（約400区画）", "港町八幡浜の平坦型霊苑。"
    ],
    [
        24, "南予", "宇和島市", "宇和島中央霊園 / 九島墓地", "宇和島石材開発協同組合 / 宇和島市生活環境課",
    ...
    [
        25, "南予", "西予市", "南予メモリアルパーク", "西予石材加工組合 / 管理事務所",
        "民間公園霊園", "愛媛県西予市宇和町卯之町", "0894-62-1483",
        "組合案内所", "電話受付",
        "中規模（約350区画）", "卯之町近郊の広域霊苑。"
    ]
]

apply_sheet_layout(
    ws_ehime,
    "【愛媛県】主要墓地・霊園管理会社・管理事務所一覧名鑑（中予・東予・南予 徹底網羅版）",
    "愛媛県（中予・東予・南予）の主要な民間霊園管理会社、総合エージェント、指定管理団体、市営墓地窓口を完全整理",
    "1E3A8A", # インディゴネイビー
    ehime_headers,
    ehime_data
)
